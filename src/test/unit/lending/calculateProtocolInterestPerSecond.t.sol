...
contract TestCalculateProtocolInterestPerSecond is Test, OffersLoansRefinancesFixtures {
    function setUp() public override {
        super.setUp();
    }

    function _test_calculateProtocolInterestPerSecond_works(
        uint128 amount,
        uint32 duration,
        ...
        uint96 protocolInterestPerSecond = lending.calculateProtocolInterestPerSecond(
            amount,
            duration
        );
    ...
    function test_fuzz_calculateProtocolInterestPerSecond_works(
        uint128 amount,
        uint32 duration,
        uint16 protocolInterestBps
    ) public {
        ...
        _test_calculateProtocolInterestPerSecond_works(amount, duration, protocolInterestBps);
    }

    function test_unit_calculateProtocolInterestPerSecond_works() public {
