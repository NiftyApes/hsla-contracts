...
contract TestMarkSignatureUsed is Test, BaseTest, IOffersEvents, OffersLoansRefinancesFixtures {
    ...
    function test_unit_markSignatureUsed_works() public {
        ...
        vm.startPrank(address(sigLending));
        offers.markSignatureUsed(offer, signature);
        vm.stopPrank();
    }

    function test_unit_cannot_markSignatureUsed_not_sigLending() public {
        Offer memory offer = Offer({
            creator: lender1,
            nftContractAddress: address(0xB4FFCD625FefD541b77925c7A37A55f488bC69d9),
            interestRatePerSecond: 3,
